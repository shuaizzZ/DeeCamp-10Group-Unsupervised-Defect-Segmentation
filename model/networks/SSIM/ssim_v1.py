...
class Encoder(nn.Module):
    def __init__(self, code_dim):
        ...
        self.conv1 = BNConv(in_planes=3, out_planes=32, kernel_size=4, stride=2, padding=1, relu=False)
        self.activation1 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.conv2 = BNConv(in_planes=32, out_planes=32, kernel_size=4, stride=2, padding=1, relu=False)
        self.activation2 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.conv3 = BNConv(in_planes=32, out_planes=32, kernel_size=3, stride=1, padding=1, relu=False)
        self.activation3 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.conv4 = BNConv(in_planes=32, out_planes=64, kernel_size=4, stride=2, padding=1, relu=False)
        self.activation4 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.conv5 = BNConv(in_planes=64, out_planes=64, kernel_size=3, stride=1, padding=1, relu=False)
        self.activation5 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.conv6 = BNConv(in_planes=64, out_planes=128, kernel_size=4, stride=2, padding=1, relu=False)
        self.activation6 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.conv7 = BNConv(in_planes=128, out_planes=64, kernel_size=3, stride=1, padding=1, relu=False)
        self.activation7 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.conv8 = BNConv(in_planes=64, out_planes=32, kernel_size=3, stride=1, padding=1, relu=False)
        self.activation8 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.conv9 = BNConv(in_planes=32, out_planes=code_dim, kernel_size=8, stride=1, padding=0, relu=False)
...
class Decoder(nn.Module):
    def __init__(self, code_dim):
        ...
        self.deconv1 = BNDeConv(in_planes=code_dim, out_planes=32, kernel_size=8, stride=1, padding=0, relu=False)
        self.activation1 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.deconv2 = BNDeConv(in_planes=32, out_planes=64, kernel_size=3, stride=1, padding=1, relu=False)
        self.activation2 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.deconv3 = BNDeConv(in_planes=64, out_planes=128, kernel_size=3, stride=1, padding=1, relu=False)
        self.activation3 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.deconv4 = BNDeConv(in_planes=128, out_planes=64, kernel_size=4, stride=2, padding=1, relu=False)
        self.activation4 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.deconv5 = BNDeConv(in_planes=64, out_planes=64, kernel_size=3, stride=1, padding=1, relu=False)
        self.activation5 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.deconv6 = BNDeConv(in_planes=64, out_planes=32, kernel_size=4, stride=2, padding=1, relu=False)
        self.activation6 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.deconv7 = BNDeConv(in_planes=32, out_planes=32, kernel_size=3, stride=1, padding=1, relu=False)
        self.activation7 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.deconv8 = BNDeConv(in_planes=32, out_planes=32, kernel_size=4, stride=2, padding=1, relu=False)
        self.activation8 = nn.LeakyReLU(inplace=True, negative_slope=0.2)
        self.deconv9 = BNDeConv(in_planes=32, out_planes=3, kernel_size=4, stride=2, padding=1, relu=False)
        self.activation9 = nn.ReLU(inplace=True)
